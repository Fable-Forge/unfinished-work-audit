...
```text
安装 unfinished-work-audit：https://raw.githubusercontent.com/Fable-Forge/unfinished-work-audit/main/docs/install.md
```
...
从 `https://github.com/Fable-Forge/unfinished-work-audit` 安装 `unfinished-work-audit`，验证目标目录和 `SKILL.md`，并诚实报告哪些 Agent 已可发现。
...
| 运行时 | 目标目录 |
|---|---|
| Codex | `~/.codex/skills/unfinished-work-audit/` |
| Claude Code | `~/.claude/skills/unfinished-work-audit/` |
| Agent Skills | `~/.agents/skills/unfinished-work-audit/` |
